...
use esp_hal::{delay::Delay, gpio::{Level, Output, OutputConfig}, peripherals::Peripherals, spi::{Mode, master::{Config, Spi}}, time::Rate};
use lebron_core::{HEIGHT, WIDTH};
use mipidsi::{Builder, interface::SpiInterface, models::ST7789, options::ColorInversion};

pub fn new_display(peripherals: Peripherals, buffer: &mut [u8]) -> impl DrawTarget<Color = Rgb565>
{
